const examComponents={
    ...
    <section class="test-type-section row mx-0">
      <div class="col-lg-6 col-12 mb-4">   
        <div class="test-type-container h-100 structured-test" onclick = "examView.loadTest('structuredTest','.structured-test')">
      ...
      <div class="col-lg-6 col-12 mb-4">   
        <div class="test-type-container h-100 random-test" onclick="examView.loadTest('randomTest','.random-test')">    
